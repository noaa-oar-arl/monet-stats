...
class TestContingencyMetrics:
    ...
    def test_pod_perfect_detection(self) -> None:
    ...
    def test_pod_no_detection(self) -> None:
    ...
    def test_pod_partial_detection(self) -> None:
    ...
    def test_far_no_false_alarms(self) -> None:
    ...
    def test_far_all_false_alarms(self) -> None:
    ...
    def test_csi_perfect_score(self) -> None:
    ...
    def test_csi_worst_score(self) -> None:
    ...
    def test_fbi_underprediction(self) -> None:
    ...
    def test_tss_range_bounds(self) -> None:
    ...
    def test_ets_range_bounds(self) -> None:
    ...
    def test_hss_range_bounds(self) -> None:
    ...
    def test_probability_metrics_range(self, metric_func, expected_range) -> None:
    ...
    @pytest.mark.unit
    def test_contingency_metrics_mathematical_correctness(self) -> None:
    ...
    @pytest.mark.slow
    def test_contingency_metrics_performance(self) -> None:
    ...
    def test_bss_binary_perfect_score(self) -> None:
    ...
    def test_bss_binary_worst_score(self) -> None:
    ...
    def test_threshold_optimization_functions(self) -> None:
