...
def modified_index_of_agreement(obs, mod):
    """Alias for d1 (Modified Index of Agreement)"""
    from .correlation_metrics import d1
    return d1(obs, mod)

def akaike_information_criterion(obs, mod):
...
def bayesian_information_criterion(obs, mod):
